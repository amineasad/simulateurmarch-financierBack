...
import tn.esprit.examen.nomPrenomClasseExamen.dto.TraderAnalysisResponse.StrategyResult;
                    ...
                    if (listObj instanceof List<?>) {
                        for (Object o : (List<?>) listObj) {
                            if (o instanceof java.util.Map<?, ?>) {
                                ...
                                s.setWinRate(Double.parseDouble(String.valueOf(map.getOrDefault("winRate", 0))));
                                s.setProfitFactor(Double.parseDouble(String.valueOf(map.getOrDefault("profitFactor", 1))));
                                s.setPnlTotal(Double.parseDouble(String.valueOf(map.getOrDefault("pnlTotal", 0))));
                                strategies.add(s);
                            }
